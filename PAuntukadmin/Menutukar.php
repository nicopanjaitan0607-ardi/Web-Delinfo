...
<br><br>
 <div class="breadcrumb-holder">
    <ul class="angled-breadcrumbs">
           <li>
<a href="caritukar.php" class="cari">Cari Pertukaran Mahasiswa</a>
    </li>
      <li>
<a href="tambahmenutukar.php" class="cari">Tambahkan Pertukaran Mahasiswa</a>
    </li>
...
<div class="list-content">
     <td>
          <img src="GambarPertukaran/<?= $row ["gambartukar"]; ?>" width="100">
     </td>
      <h2 class=""><?= $row ["namatukar"]; ?></h2>
      <a href="<?= $row ["linkk"]; ?>" > <button class="button"><span>Baca </span></button></a>  
