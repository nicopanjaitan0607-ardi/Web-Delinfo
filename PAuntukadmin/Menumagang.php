...
<br><br>
 <div class="breadcrumb-holder">
    <ul class="angled-breadcrumbs">
           <li>
<a href="carimagang.php" class="cari">Cari Lowongan Magang</a>
    </li>
  <li>
<a href="tambahmenumagang.php" class="cari">Tambahkan Lowongan Magang</a>
    </li>
...
<div class="list-content">
     <td>
          <img src="GambarMagang/<?= $row ["gambarmagang"]; ?>" width="100">
     </td>
      <h2 class=""><?= $row ["namamagang"]; ?></h2>
      <a href="<?= $row ["linkz"]; ?>" > <button class="button"><span>Baca </span></button></a>  
