...
<?php
//koneksi databases
include('paginationbeasiswa.php');
...
<div class="list-content">
     <td>
          <img src="GambarBeasiswa/<?= $row ["gambarbeasiswa"]; ?>" width="100">
     </td>
      <h2 class=""><?= $row ["namabeasiswa"]; ?></h2>
      <a href="<?= $row ["linked"]; ?>" > <button class="button"><span>Baca </span></button></a>  
...
<footer class="text-center">
  <a class="up-arrow" href="#myPage" data-toggle="tooltip" title="Ke Atas">
  ...
  <main class="valign-wrapper">
    ...
    <script src="js/ajaxbeasiswa.js"></script>
